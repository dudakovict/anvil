            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.healthStatus"
                        }
                    }
                }
            }
        ...
        "/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "comma-separated sort fields, minus prefix for descending (e.g. -created_at,name)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rest.UsersPage"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "web.ErrorResponse": {
            ...
            "properties": {
                ...
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/validate.FieldError"
                    }
                }
            }
        }
